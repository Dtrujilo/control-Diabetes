<%@ Page Title="" Language="C#" MasterPageFile="~/PageMaster/MP.Master" AutoEventWireup="true" CodeBehind="FormularioCitas.aspx.cs" Inherits="Control_Tipos_Diabetes.Pages.FormularioCitas" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="card" style="max-width: 1000px; margin: 0 auto; background-color: #e6fffa;">
        ...
        <div class="container">
            <div class="table-responsive">
                <asp:GridView runat="server" ID="gvlistadecitas" CssClass="table table-borderless table-hover table-sm">
                    <Columns>
